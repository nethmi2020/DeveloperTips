...
<body>
    ...
    <ul style="border-bottom:1px solid black;">
     ...
     <li><a href="/userhome/{{$user->id}}" style="margin-left:550px; color:white;">Home</a></li>
      <li><a href="/seeuserlogvedios/{{$user->id}}" style="margin-left:50px; color:white;">Tutorial</a></li>
      <li><a href="/seeallposts/{{$user->id}}" style="margin-left:50px; color:white;">Blog</a></li>
     <li><a href="/index " style="margin-left:50px; color:white;">Logout</a>
     <img src="{{asset('uploads/u/'.$user->image)}}" style="margin-left:30px;  width:35px;  height:35px; border-radius:100px;" class="card-img-top rounded" alt="...">
...
<br><br><br><br> <br><br><br><br>
     ...
     <div class="row" style="background-color:#696969; margin-left:-200px; margin-right:-200px;" >
      ...
      <img src="{{asset('uploads/u/'.$user->image)}}" style=" margin-left:200px; width:300px;  height:300px; border-radius:500px;" class="card-img-top rounded" alt="...">
     <br>  <br>   <br> <button class="btn btn-success"  style=" margin-left:300px;"><a  style="color:white;" href="/updateuserdetail/{{$user->id}}">Edit Details</a></button>  <br><br>
  ...
  <li style="list-style-type:none;"><a href="/seeallposts/{{$user->id}}" style="color:black; margin-left:200px;"> <i class="fa fa-check-square-o" aria-hidden="true"></i></a></li>
  </h4> </div>
 </div>
      </div>
     </div>
...
<div class="row" style="padding:50px;">
   ...
   <ul>
     <li><a href="/seeuserlogvedios/{{$user->id}}" style="color:black; font-size:20px;  text-decoration:none;">Tutorial</a></li><br><br>
    
     <li><a href="/seeallposts/{{$user->id}}" style="color:black; font-size:20px;  text-decoration:none;">BLOG</a></li>
   </ul> </p>
    </div>
