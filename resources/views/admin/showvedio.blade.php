...
<div class="btn-group">
  ...
  <h4 style="color:black; width:400px; padding:10px; ">Select Catergory </h4>
  </button>
  <div class="dropdown-menu" style="padding:10px; width:400px;">
      <ul>
          <li style="list-style-type:none;"> <a @foreach($data as $datas) href="/frontend/{{$datas->catergory}}" @endforeach>Front End Developer Tips</a></li> 
          <li style="list-style-type:none;"><a href="/backend/{{$datas->catergory}}">Backend End Developer Tips</a></li>
          <li style="list-style-type:none;"><a href="/backend">Others</a></li>
    </ul>  
  </div>
</div>

<br><br><br> <br><br><br> <br><br><br>
  <h2 style="color:white; margin-left:500px;">Vedio List</h2>
  <br><br>
